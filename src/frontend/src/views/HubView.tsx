    ...
    <div className="min-h-screen flex flex-col pb-20">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-5 py-8">
        {showAuthPrompt ? (
          <div className="flex items-center justify-center min-h-[60vh]">
            <div className="text-center max-w-md space-y-6 p-8 rounded-2xl backdrop-blur-xl bg-card/40 border border-border/60">
              <div className="space-y-2">
                <h2 className="text-3xl font-black bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                  Account Required
                </h2>
                <p className="text-muted-foreground text-lg">
                  You need to create an account on <span className="font-bold text-primary">proxy</span> to view and post tasks.
                </p>
              </div>
              <Button
                onClick={handleNavigateToProfile}
                className="bg-gradient-to-r from-primary to-accent hover:opacity-90 text-primary-foreground font-bold px-8 py-6 text-lg"
              >
                Create Account
              </Button>
            </div>
      ...
      {!showAuthPrompt && (
        <Button
          ...
          disabled={!isActorReady || !hasProfile}
