...
import type { ExternalBlob as _ExternalBlob, Stars as _Stars, Task as _Task, TaskId as _TaskId, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async assignPerformer(arg0: TaskId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignPerformer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completeTask(arg0: TaskId, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeTask(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTask(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string, arg5: string, arg6: ExternalBlob, arg7: Time | null): Promise<TaskId> {
        if (this.processError) {
            try {
                const result = await this.actor.createTask(arg0, arg1, arg2, arg3, arg4, arg5, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n11(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createUserProfileWithGoogle(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createUserProfileWithGoogle(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCommentsForTask(arg0: bigint): Promise<Array<[string, string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCommentsForTask(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleTelegramDiscussion(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleTelegramDiscussion(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyTask(arg0: TaskId, arg1: Stars, arg2: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyTask(arg0, to_candid_Stars_n27(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        gmailAddress: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.gmailAddress)),
        name: value.name,
        postHistory: value.postHistory
    };
}
async function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    location: string;
    telegramHandle: string;
    verificationPhoto: [] | [_ExternalBlob];
}): Promise<{
    id: TaskId;
    taskPhoto: ExternalBlob;
    title: string;
    ...
    return {
        id: value.id,
        taskPhoto: await from_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.taskPhoto),
        title: value.title,
        creator: value.creator,
        isCompleted: value.isCompleted,
        performer: record_opt_to_undefined(from_candid_opt_n22(_uploadFile, _downloadFile, value.performer)),
        deadline: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.deadline)),
        isVerified: value.isVerified,
        safeSpot: value.safeSpot,
        telegramDiscussionEnabled: value.telegramDiscussionEnabled,
        category: value.category,
        price: value.price,
        location: value.location,
        telegramHandle: value.telegramHandle,
        verificationPhoto: record_opt_to_undefined(await from_candid_opt_n24(_uploadFile, _downloadFile, value.verificationPhoto))
    };
}
...
function to_candid_Stars_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Stars): _Stars {
...
function to_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        gmailAddress: value.gmailAddress ? candid_some(value.gmailAddress) : candid_none(),
        name: value.name,
        postHistory: value.postHistory
    };
}
...
function to_candid_variant_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Stars): {
    one: null;
} | {
    two: null;
} | {
